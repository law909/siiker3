...
ob_start(); /* template body */ ?><div class="partner_be_w" id="partner_belepes">
	...
	<div class="az_jel">
		<form id="LoginForm" method="post" action="<?php echo $this->scope["login"]["actionuri"];?>">
			<label><?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',    1 => '->',  ),  2 =>   array (    0 => 'partner',    1 => 'azonosito',  ),  3 =>   array (    0 => '',    1 => '',    2 => '',  ),), $this->scope["text"], false);?></label><input id="LoginNevEdit" type="text" size="8" name="user_login_nev" class="general_input_part"/>
			...
			<div class="bej_reg"><input type="submit" value="<?php echo $this->readVarInto(array (  1 =>   array (    0 => '->',    1 => '->',  ),  2 =>   array (    0 => 'partner',    1 => 'bejelentkezesgomb',  ),  3 =>   array (    0 => '',    1 => '',    2 => '',  ),), $this->scope["text"], false);?>" name="x" class="general_button"/><br />
